    ...
    <div class="dashboard-wrapper">
        ...
        <aside class="sidebar">
            ...
            <nav>
                ...
                <a href="{{ route('mystocks') }}">Stocks</a>
                <a href="#">FDs</a>
                <a href="#">Properties</a>
        ...
        <main class="main-content">
            ...
            <div class="dashboard-cards">
                ...
                <div class="card">
                    ...
                    <div class="card-value">₹{{ number_format($totalvalueStock, 2) }}</div>
                    <a href="{{ route('mystocks') }}" class="card-link">View My Stocks</a>
                </div>
                <div class="card">
                    <div class="card-title">FDs Value</div>
                    <div class="card-value">₹{{ number_format($totalvalueFds, 2) }}</div>
                </div>
                <div class="card">
                    <div class="card-title">Properties Value</div>
                    <div class="card-value">₹{{ number_format($totalvalueProperties, 2) }}</div>
                </div>
            </div>
            ...
            <div class="container">
                <h2>Add FD</h2>
                <form action="{{ route('add.fd') }}" method="POST">
                    @csrf
